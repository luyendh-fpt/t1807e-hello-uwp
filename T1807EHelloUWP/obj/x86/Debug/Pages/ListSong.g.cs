#pragma checksum "C:\Users\xuan hung\source\repos\T1807EHelloUWP\T1807EHelloUWP\Pages\ListSong.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "E1C4E689DB7BC23DA0F4DB4966611DA6"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace T1807EHelloUWP.Pages
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class ListSong_obj1_Bindings :
            ...
            IListSong_Bindings
        {
            private global::T1807EHelloUWP.Pages.ListSong dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::T1807EHelloUWP.Pages.ListSong)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::T1807EHelloUWP.Pages.ListSong obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Songs(global::System.Collections.ObjectModel.ObservableCollection<global::T1807EHelloUWP.Entity.Song> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
